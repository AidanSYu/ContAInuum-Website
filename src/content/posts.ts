...
export const POSTS: Post[] = [
  {
    ...
    body: [
      ...
      'So Asilia retrofits. It plans a campaign toward your objective, executes the steps it can, and pauses for the steps that still need hands. When it pauses, a scientist returns a result, a TLC read, a CSV, a note, and the run resumes from exactly where it stopped. Correct a tool call once, and that correction becomes signal.',
      'The compounding part is the point. Most labs discard their most expensive knowledge at the end of a campaign. Asilia keeps it: recipes, failure modes, supplier quirks, the lore that lives in people’s heads. The next campaign starts from what the last one learned, in your lab, for your targets.',
