...
export const POSTS: Post[] = [
  {
    ...
    body: [
      ...
      'We started contAInuum from the opposite premise. The lab you run today is the asset. Your instruments work. Your scientists know things no model does. What is missing is not hardware — it is memory, and an autonomy layer that respects the bench.',
